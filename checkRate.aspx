<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checkRate.aspx.cs" Inherits="scrap.checkRate" %>
 ...
 <!-- Spinner Start -->
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="checkRate.aspx" class="nav-item nav-link">Check Rate List</a>
    ...
    <div class="container-fluid page-header py-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-2 text-dark mb-4 animated slideInDown">Rate List</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="index.aspx">Home</a></li>
                    <li class="breadcrumb-item text-dark" aria-current="page">Check Rate List</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal">
                <ItemTemplate>
                    <table class="auto-style1">
                        <tr>
                            <td>
                                <asp:Image ID="Image1" runat="server" Height="94px" ImageUrl='<%# "data:image/png;base64,"+Convert.ToBase64String((byte[])Eval("image"),0,((byte[])Eval("image")).Length) %>' Width="213px" />
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("item_id") %>' OnClick="LinkButton1_Click">VIEW</asp:LinkButton>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                    </table>
