<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reg.aspx.cs" Inherits="scrap.reg" %>
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
                ...
                <br />
                    ...
                    <asp:TextBox ID="TextBox3" placeholder="password" TextMode="Password" runat="server"></asp:TextBox>
                ...
                <br />
                    <asp:TextBox ID="TextBox4" placeholder="password" TextMode="Password" runat="server"></asp:TextBox>
