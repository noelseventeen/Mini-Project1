<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="oursafter.aspx.cs" Inherits="scrap.oursafter" %>
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        <a href="indexafterlogin.html" class="nav-item nav-link active">Home</a>
                        <a href="aboutafter.aspx" class="nav-item nav-link">About</a>
                        <a href="oursafter.aspx" class="nav-item nav-link">Our Initiatives</a>
                        <a href="viewSchedule.aspx" class="nav-item nav-link">Sell</a>
                        <a href="contactafter.html" class="nav-item nav-link">Contact</a>
                        <a href="cancelation.aspx" class="nav-item nav-link">Bookings</a>
        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="indexafterlogin.html">Home</a></li>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="aboutafter.aspx">About Us</a>
                    <a class="btn btn-link" href="contact.html">Contact Us</a>
                    <a class="btn btn-link" href="oursafter.aspx">Our Initiatives</a>
                </div>
                <div class="col-lg-3 col-md-6">
